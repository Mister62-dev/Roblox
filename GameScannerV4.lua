-- Roblox Game Scanner | Mobile V4 | Anti-Freeze
...
-- ══ SCAN ITERATIF — pas de récursion profonde, yield /10 instances ══
...
Btn.MouseButton1Click:Connect(function()
    ...
    -- Itératif via stack — évite la récursion qui bloque le thread
    local counter=0
    local function scanService(root)
        ...
        while #stack>0 do
            ...
            -- Yield toutes les 10 instances — game reste fluide
    ...
    if Toggles.Export then
        ...
        setStatus("✔ "..#Res.." éléments",C.Accent)
    end
