-- Roblox Game Scanner | Mobile Edition V2.1
-- Delta Executor | Août 2026
-- Bouton visible — nav bar compensée
...
do
    ...
    local function beginDrag(pos) drag=true startInput=pos startPos=Main.Position end
    ...
    TB.InputBegan:Connect(function(i)
        ...
        elseif i.UserInputType==Enum.UserInputType.Touch then beginDrag(i.Position) end
    end)
    ...
    UIS.InputChanged:Connect(function(i)
        if i.UserInputType==Enum.UserInputType.MouseMovement then moveDrag(i.Position)
        elseif i.UserInputType==Enum.UserInputType.Touch then moveDrag(i.Position) end
    end)
end
...
local LogF=make("Frame",{Size=UDim2.new(1,0,0,100),
